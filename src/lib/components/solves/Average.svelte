...
{#if solves && solves.length === count}
	<dialog bind:this={modal} class="rounded-xl bg-white py-4 px-4 font-sans text-primary md:px-0">
		...
		<div class="mx-4 mt-2 max-h-72 overflow-y-auto pr-4 text-2xl md:mx-8">
		...
		<form method="dialog" class="mt-2 flex justify-center gap-4">
			...
			>
			<button class="rounded-xl bg-primary py-2 px-4 text-xl text-white" on:click={copyClipboard}
				>Copy</button
			>
		</form>
	</dialog>
